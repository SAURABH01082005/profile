...
export default function SchoolAchievements() {
  const { schoolAchievements } = profileData;
  ...
  useEffect(() => {
    if (isPaused || schoolAchievements.length <= 1) return;
  ...
  return (
    <section id="school-achievements" className="relative py-20 overflow-hidden bg-zinc-950/20 light-theme:bg-zinc-50/50 border-t border-zinc-900 light-theme:border-zinc-200">
      
      {/* Decorative radial glow */}
      <div className="absolute top-[40%] right-[-10%] w-[35vw] h-[35vw] rounded-full radial-glow-secondary opacity-15 pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white light-theme:text-zinc-900 font-heading">
            School <span className="bg-gradient-to-r from-violet-400 to-indigo-400 bg-clip-text text-transparent">Achievements</span>
          </h2>
          ...
          <p className="text-zinc-400 light-theme:text-zinc-500 mt-4 leading-relaxed">
            A chronicle of foundational academic honors, leadership milestones, and early science exhibition placements from high school.
          </p>
        </div>
        ...
        {schoolAchievements.length > 0 && (
          <div className="flex justify-end gap-3 mb-8 max-w-5xl mx-auto">
            <button 
              ...
              aria-label="Previous School Achievement"
            >
            ...
            <button 
              onClick={scrollRight}
              className="w-10 h-10 rounded-xl bg-zinc-900/80 light-theme:bg-zinc-100 hover:bg-zinc-850 light-theme:hover:bg-zinc-200 border border-zinc-805 light-theme:border-zinc-300 text-zinc-400 light-theme:text-zinc-650 hover:text-white light-theme:hover:text-zinc-955 transition-all duration-300 shadow-md hover:border-violet-500/40 cursor-pointer active:scale-95 flex items-center justify-center"
              aria-label="Next School Achievement"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="p-6 sm:p-7 flex-grow flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-3">
                    ...
                    <span className="px-2.5 py-0.5 rounded bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[9px] font-bold uppercase tracking-wide">
                      High School Honor
                    </span>
                  </div>
                  ...
                  {/* Description */}
                  <p className="text-xs sm:text-sm text-zinc-400 light-theme:text-zinc-600 leading-relaxed">
                    {item.description}
                  </p>
                ...
                <div className="pt-4 border-t border-zinc-900 light-theme:border-zinc-200 mt-6 flex justify-end">
                  {item.imageUrl && (
                    <button
                      onClick={() => setSelectedPhoto(item)}
      ...
      {/* Light Full-Screen Modal for certificates */}
      {selectedPhoto && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-955/90 backdrop-blur-md animate-fade-in-up">
          <div className="relative w-full max-w-3xl glass-panel border border-zinc-850 light-theme:border-zinc-300 rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="flex items-center justify-between p-5 border-b border-zinc-900 bg-zinc-950">
              <div>
                ...
                <p className="text-xs text-zinc-400 mt-0.5">
                  {selectedPhoto.organization} — Verified School Record
                </p>
              </div>
              <button 
            ...
            <div className="flex-grow p-4 bg-zinc-955 flex flex-col items-center justify-center overflow-y-auto max-h-[60vh] select-none">
              <img 
